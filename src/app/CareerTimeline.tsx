	...
	return (
		<motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.35 }}>
			...
			<div className="page-content career-timeline">
				...
				<TimelineSegment year="2025" range="Feb 2012 - Present" title="Miroma Project Factory" roles={["Tech Team Lead (2020 - present)", "Senior Front-end Developer", "Designer Developer"]} skills={['React, NextJS', 'Javascript, Typescript', 'Flutter', 'Cordova', 'Three.js', 'AI, LLMs', 'NodeJS', 'AWS, Heroku', 'Accessibility', 'Drupal, Drupal Theming', 'Team Leadership', 'Project Planning, Discovery', 'Code Reviews, Code Collaboration']}></TimelineSegment>
