	...
	return (
		<>
			...
			<div className="page-content career-timeline">
				...
				<TimelineSegment year="2025" range="Feb 2021 - Present" title="Miroma Project Factory" roles={["Developer", "Senior Developer"]} skills={['React / NextJS', 'JS/TS', 'Cordova', 'Flutter', 'Three.js', 'AI / LLMs', 'NodeJS development', 'Accessibility', 'Drupal and theme development', 'Team Leadership', 'Project Management & planning', 'Coding standards and styling', 'Code Reviews and collaboration']}></TimelineSegment>
